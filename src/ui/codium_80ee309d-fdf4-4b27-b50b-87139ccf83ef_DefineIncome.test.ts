...
describe('code snippet', () => {
    ...
    // User is prompted for the income date
    it('should prompt the user for the income date when DefineIncome is called', async () => {
        const inputMock = jest.spyOn(require('@inquirer/prompts'), 'input').mockResolvedValue('01/01/2023');
